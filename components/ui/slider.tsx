    ...
    >
      ...
      >
        <SliderPrimitive.Track
          className="relative select-none overflow-hidden rounded-none bg-muted data-horizontal:h-1 data-vertical:h-full data-horizontal:w-full data-vertical:w-1"
