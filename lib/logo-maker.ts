...
export const ICON_CATEGORIES = {
  shapes: ["circle", "square", "triangle", "hexagon", "star", "heart", "diamond"],
  arrows: ["arrow-up", "arrow-right", "arrow-down", "arrow-left", "chevron-right", "chevron-up"],
  tech: ["code", "terminal", "database", "cloud", "server", "cpu", "wifi", "bluetooth"],
  ui: ["home", "settings", "user", "search", "menu", "plus", "minus", "check", "x"],
  media: ["play", "pause", "music", "image", "video", "camera", "mic"],
  business: ["briefcase", "chart", "mail", "phone", "calendar", "clock", "bookmark"],
...
export const ICON_PATHS: Record<string, string> = {
  ...
  hexagon: "M21 16.5c0 .38-.21.71-.53.88l-7.94 4.41c-.3.17-.65.17-.95 0l-7.94-4.41A1 1 0 013 16.5v-9c0-.38.21-.71.53-.88l7.94-4.41c.3-.17.65-.17.95 0l7.94 4.41c.32.17.53.5.53.88v9z",
  ...
  database: "M12 3c4.97 0 9 1.79 9 4s-4.03 4-9 4-9-1.79-9-4 4.03-4 9-4zM3 7v5c0 2.21 4.03 4 9 4s9-1.79 9-4V7M3 12v5c0 2.21 4.03 4 9 4s9-1.79 9-4v-5",
  ...
  image: "M19 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zM8.5 10a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm.5 11l5-7 5 7H9z",
  ...
  phone: "M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.362 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.574 2.81.7A2 2 0 0122 16.92z",
  ...
  flower: "M12 7a5 5 0 100-10 5 5 0 000 10zM12 22v-5M12 7a5 5 0 00-3 9M12 7a5 5 0 013 9M7 14H3M21 14h-4",
  ...
  "at-sign": "M16 12a4 4 0 10-8 0 4 4 0 008 0zm5 0v1.5a2.5 2.5 0 01-5 0V12a9 9 0 10-3.5 7.13",
};
...
export const generateLogoSVG = (config: LogoConfig): string => {
  ...
  const iconStroke = icon.borderWidth > 0 ? `stroke="${icon.borderColor}" stroke-width="${icon.borderWidth}"` : "";
  ...
  try {
    ...
    const configToSave: LogoConfig = {
      ...
      icon: {
        ...
        ...(config.icon.type === "image" && config.icon.value.startsWith("data:")
