    ...
    <div className="markdown-body">
      <ReactMarkdown
        ...
        h3: ({ children, ...props }) => {
          ...
          const id = slugify(text);
          return (
            <h3 className="mb-2 mt-4 font-semibold text-lg" id={id} {...props}>
              {children}
            </h3>
          );
        },
        h4: ({ children, ...props }) => {
          ...
          const id = slugify(text);
          return (
            <h4 className="mb-2 mt-3 font-semibold text-base" id={id} {...props}>
              {children}
            </h4>
          );
        },
        h5: ({ children, ...props }) => {
          ...
          const id = slugify(text);
          return (
            <h5 className="mb-1 mt-2 font-semibold text-sm" id={id} {...props}>
              {children}
            </h5>
          );
        },
