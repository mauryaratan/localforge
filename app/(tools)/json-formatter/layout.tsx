...
export const metadata: Metadata = {
  ...
  description:
    "Format, validate, and query JSON data with JSONPath. Features syntax highlighting, tree view, minification, and real-time validation. Privacy-first — runs entirely in your browser.",
  keywords: [
    "json",
    "json formatter",
    "json validator",
  ...
  openGraph: {
    title: "JSON Formatter & Validator - LocalForge",
    description:
